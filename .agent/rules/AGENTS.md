...
This repository uses the [Meridian](https://github.com/colabcolibri/meridian) protocol. The kit source of truth is `.agent/`; product docs live under `docs/` of the **active Meridian product** at the repository root (this repo dogfoods `docs/` next to `.agent/`).
...
Monorepo dogfood: `python3 .agent/scripts/validate_meridian.py .`
