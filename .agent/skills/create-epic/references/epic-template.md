...
> **v11 delivery:** shape of `epics.body_markdown` plus frontmatter mapped to SQLite (`id`, `title`, `status`, `versions`, …). **Not** `docs/epics/EPIC-XX.md`. Persist with `meridian_db_cli.py create-epic` or `--write-form`.
>
