...
**Canonical refine gates:** `.agent/skills/us-refine/references/refine-checklist.md` (same rows — review reports pass/fail; refine fixes Plan; **`ready: true` only via `/review-us` DoR attest**).
