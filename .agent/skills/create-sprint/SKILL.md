...
4. Upsert via `meridian_db_cli.py create-sprint --version vX --title "..." --stories US-0001` or `meridian_db_export.py . --entity sprints --id vX-SY --write-form`.
5. New US → `/create-us` after gates (board refreshes on DB save).
