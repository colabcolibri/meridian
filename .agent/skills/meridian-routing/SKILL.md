...
| Epic (capability) | "create epic", "new epic", `/create-epic`, `EPIC-` | `documentation-strategist` + skill `create-epic` | yes |
...
| Version / sprint | "version", "sprint", "roadmap", `/create-version`, `/plan-sprint` | `sprint-planner` + skill `create-version` / `create-sprint` | yes |
...
| User story / board | "user story", "US-", "kanban", "acceptance" | `board-keeper` | yes |
