...
2. **Mandatory read:** `sprint-template.md` + `meridian_db_cli.py show vX-SY --full` **before** editing status
...
2. Read sprint row + listed US statuses via `meridian_db_cli.py show`
