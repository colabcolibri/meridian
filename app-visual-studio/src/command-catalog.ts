...
export const MERIDIAN_COMMAND_CATALOG: CommandHelpEntry[] = [
  ...
  },
  {
    ...
    group: "governance",
    summary: "Shows kit detection and workspace paths",
    details: [
      "Project root (where .agent/MERIDIAN.md lives).",
      "Resolved docs/ path (monorepo: app-desktop/docs).",
      "Count of parseable user stories in docs/us/.",
    ],
    outputChannel: "Meridian Tools",
    icon: "$(info)",
    status: "shipped",
