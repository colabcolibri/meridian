...
export const MERIDIAN_COMMAND_CATALOG: CommandHelpEntry[] = [
  ...
  },
  {
    ...
    details: [
      "Nodes = user stories; edges = dependsOn from SQLite planning export.",
      "Filter by version and sprint; click a node to open the US virtual document.",
  ...
  },
  {
    ...
    details: [
      "Pick a package folder; extension spawns the kit Python CLI (no shell injection).",
      "Nodes = files; edges = static imports; open a file from the node list.",
      "Does not mix delivery US nodes into this canvas.",
    ],
